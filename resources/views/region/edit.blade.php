...
<div class="contenue">
      ...
      <form action="{{ route('updateregion') }}" method="POST" class="formClient" id="formClient" onsubmit="return validationClient()">
    @csrf
        <fieldset class="fieldset">
          ...
          <div class="itemFieldset">
            ...
            <div>
              ...
              <input type="text" name="id" id="id" value="{{$region->id}}" readonly/>
            </div>
            <div>
              <label for="nom">Nom</label>
              <input type="text" name="nom" id="nom" value="{{$region->nom}}" />
            </div>
